// consumer_find_package example — minimal edge-tts-cpp consumer.
//
// This file demonstrates the public API surface available after linking
// edge_tts::tts via find_package(edge_tts_cpp CONFIG REQUIRED).
//
// Include the umbrella header; it exposes SpeechSynthesizer, TtsConfig,
// SynthesisOptions, Voice, Result<T>, and ErrorCode.
//
...
int main() {
    ...
    std::cout << "edge-tts-cpp consumer_find_package example: OK\n";
    return 0;
}
